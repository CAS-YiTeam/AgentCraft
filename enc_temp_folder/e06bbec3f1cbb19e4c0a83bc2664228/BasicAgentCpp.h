...
public:	
    ...
    UFUNCTION(BlueprintNativeEvent, Category = "AgentCraft")
        void OnAgentUpdateStatus();
    UPROPERTY(BlueprintReadWrite, Category = "AgentCraft")
        FString AgentStatus = "";


    // Create Event
    UFUNCTION(BlueprintImplementableEvent, BlueprintCallable, Category = "AgentCraft")
    ...
    UFUNCTION(BlueprintImplementableEvent)
        void OnLaunchedx(FVector LaunchVelocity, bool bXYOverride, bool bZOverride);
